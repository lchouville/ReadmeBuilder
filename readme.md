...
## ℹ️ Introduction
ReadmeBuilder is a web tool to create structured, GitHub-compatible README.md files. It offers a block-based editor, multi-page support, auto-save, and export in Markdown, HTML, and JSON, making project documentation faster and easier for developers.

## 🛠️ Installation
### Download Repository
Clone or download the repository from [https://github.com/lchouville/ReadmeBuilder.git](https://github.com/lchouville/ReadmeBuilder.git).
